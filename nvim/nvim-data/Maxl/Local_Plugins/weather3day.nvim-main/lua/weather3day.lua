...
local function create_window()
  ...
  local win_width = math.ceil(width * 0.73)
  local x_pos = 1
...
function M.show_weather(city)
  ...
  local command = string.format("curl https://wttr.in/%s'?'", city_param)
...
function M.init()
  ...
  vim.api.nvim_create_user_command("Weather3day", function(params)
